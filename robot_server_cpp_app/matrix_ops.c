/* definitions of specific matrix computation
needed for implementing the Kalman filters 
using pointers and it is optimized for speed */
...
// optimized to limit computational intensive operations
