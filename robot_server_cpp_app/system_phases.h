/* generic structured file to implement the control and 
...
int finalize;// finalisation condition for the diagnosis task
...
if(execute%4==0){ // execute SM each 200ms
	...
	switch(reconf_ctrl){
		...
		case 2: if(freeze_reconf_request<15){	
				...
				break;
		default:
				printf("SM RECONF : system is running properly...\n");
...
w_current = omegar*WHEEL_RADIUS_RIGHT_F4/WHEEL_BASE - omegal*WHEEL_RADIUS_LEFT_F4/WHEEL_BASE; // angular speed rad/s
	...
	if(l<3387){// hardcoded number of samples
	...
	double min3 = temp[0][2];
		...
		for(int i = 0;i<4;i++){
			   ...
			   if((min1==r1[1] && min2 ==r1[2] || min2==r1[2] && min3 ==r1[3] || min1==r1[1] && min3 ==r1[3])|| (min1==r2[1] && min2 ==r2[2] || min2==r2[2] && min3 ==r2[3] || min1==r2[1] && min3 ==r2[3])){ // check min 
