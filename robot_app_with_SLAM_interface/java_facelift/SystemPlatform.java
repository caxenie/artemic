...
/**
 *Aquesta classe serveix per llegir un file on l'usuari defineix l'systemPlatform de
 *forma molt senzilla.
 */
public class SystemPlatform {
    ...
    Grafcet g=null;
    String s=null;
    /** Constructor que guarda la referencia al file */
