...
import RT_App_Files.Control; // per a la consulta a través del control
...
public class Grafic extends Canvas implements Runnable{
    ...
    public void gameLoop() {
       ...
       try{
        if(xValue < getWidth() ){
            value = control.sensor.get( RobotClient.S.SM1 );// graphical output values
            ...
            value = control.sensor.get( RobotClient.S.SM2 );
